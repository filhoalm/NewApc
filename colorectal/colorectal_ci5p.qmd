...
You can listen to an informative podcast related to advances in statistical methods here:

<iframe width="100%" height="166" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//soundcloud.com/adalberto-miranda-filho/advances-in-statistical&color=%23ff5500&inverse=false&auto_play=false&show_user=true"></iframe>
...
Repository that content all the functins in R language are available [here](https://github.com/filhoalm/Breast_cancer/tree/main/RCode%208-16-22/APC/%22).
